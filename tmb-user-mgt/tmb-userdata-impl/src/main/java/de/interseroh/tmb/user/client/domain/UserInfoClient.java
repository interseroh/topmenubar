 ...
 * under the License.
 */
package de.interseroh.tmb.user.client.domain;


import de.interseroh.tmb.user.client.UserInfoResponseImpl;
...
public interface UserInfoClient extends RestService {
