...
## Interseroh-styles  
   ...
   all style are now generated by http://getBootstrap.com no mor from "lavish-bootstrap"
   
   ## variables
   colors are defined in the ## Bootstrap config.less and imported by the interseroh.less and individual.less