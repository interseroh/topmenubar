...
public class ApplauncherPopover extends Popover {
   ...
   public  ApplauncherPopover(String id){
       ScriptInjector.fromString(createPopoverHider(id)).setWindow(ScriptInjector.TOP_WINDOW).inject();
       setAlternateTemplate("<div class=\"popover\" style=\"max-width: 1000px;''\" role=\"tooltip\" data-topmenubar=\""+id+"\">" +
                   "<div class=\"arrow\"></div>" +
    ...
    private String createPopoverHider(String id){
        String jsFunction=
                "function "+CLOSE_POPOVER_JSFUNCTION+" {" +
